...
tf.app.flags.DEFINE_integer('image_height', 998, 'image height')
tf.app.flags.DEFINE_integer('image_width', 828, 'image width')
tf.app.flags.DEFINE_integer('image_channel', 1, 'image channels as input')
tf.app.flags.DEFINE_integer('road_num', 1000, 'image channels as input')
...
tf.app.flags.DEFINE_integer('input_size', 1000, 'the time step')
tf.app.flags.DEFINE_integer('output_size', 1000, 'the time step')
tf.app.flags.DEFINE_integer('cell_size', 1024, 'the time step')
tf.app.flags.DEFINE_integer('batch_size', 2, 'the time step')
